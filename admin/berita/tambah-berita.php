                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-lg-12 mt-3">
                            <button name="submit" class="btn btn-success btn-block">Tambah</button>
                        </div>
                    </div>
                </form>
            </div>
		...
		$file_tmp = $_FILES['file']['tmp_name'];
			...
			if(in_array($ekstensi, $ekstensi_boleh) === true) {
				if($ukuran < 2000000) {
					...
					$sql = mysqli_query($con, "INSERT INTO tbl_posts(img, judul, artikel, date, kategori, author) VALUES ( '$gambar', '$judul', '$artikel', '$date', '$kategori', '$author')");
