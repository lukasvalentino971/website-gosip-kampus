    ...
    <div class="col-lg-4 col-xs-12">
        <div class="card card-success">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 text-success text-uppercase"><?= $data['nama_pengguna'] ?></h5>
                <?php 
					if($_SESSION['lvluser'] == 1) {
						echo "<h5 class='text-success'>Level User : Admin</h5>";								
					} elseif($_SESSION['lvluser'] == 2) {
						echo "<h5 class='text-success'>Level User : User</h5>";
					} 
				?>
            </div>
        </div>
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-xs-12">
                            <button class="btn btn-success btn-block" name="submit">Simpan Perubahan</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-xs-12">
                            <button class="btn btn-success btn-block" name="tambah">Tambah Data</button>
                        </div>
                    </div>
                </form>
            </div>
